...
import java.nio.file.Files; // menulis dan membaca file
...
public class DataBase {
    ...
    private String filename = "src/database.csv";
    private Path path = Path.of(filename);

    // saat memanggil,langsung memanggil File
    public DataBase() {
        open();
    }
    //memanggil untuk pilihan update di class (UserInterface)
    ...
    public void view() {
        ...
        System.out.printf(" %-15.15S |", "NAMA");
        System.out.printf(" %-15.15S |", "ALAMAT");
        ...
        for (Mahasiswa mhs : data) {
            ...
            System.out.printf(" %-15.15S |", mhs.getNama());
            System.out.printf("  %-15.15S|", mhs.getAlamat());
